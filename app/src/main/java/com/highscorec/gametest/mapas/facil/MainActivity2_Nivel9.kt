...
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel22
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel23
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel24
import java.util.*

class MainActivity2_Nivel9 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿ Este código es famoso por ?"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.codigokonami)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Activar alguna opción secreta")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Vidas infinitas")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Nivel final")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("Huevo de pascua")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(MainActivity2_Nivel22::
        class.java)
        activityList.add(MainActivity2_Nivel23::
        class.java)
        activityList.add(MainActivity2_Nivel24::
        class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel22::class.java
                // We are adding the number of the activity to the list
                activityList.remove(MainActivity2_Nivel22::class.java)
            }
            2 -> {
                activity = MainActivity2_Nivel23::class.java
                activityList.remove(MainActivity2_Nivel23::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel24::class.java
                activityList.remove(MainActivity2_Nivel24::class.java)
            }
        }
        ...
        if (op1!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel9, Bonnuslive::class.java)
                    startActivity(intent)
                    mp!!.stop()
                    mp!!.release()
                }
