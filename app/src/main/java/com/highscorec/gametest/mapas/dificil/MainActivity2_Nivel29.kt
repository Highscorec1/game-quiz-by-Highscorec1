...
class MainActivity2_Nivel29 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " 1972 cuando se lanzo la primera videoconsola llamada "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable._9odessy)
        ...
        op3!!.setText(" Nintendo ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Magnavox Odyssey ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op4!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel29, MainActivity2_Nivel13::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel29, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
