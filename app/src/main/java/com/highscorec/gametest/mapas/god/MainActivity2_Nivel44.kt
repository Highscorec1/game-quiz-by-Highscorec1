...
import java.util.*
class MainActivity2_Nivel44 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿Que indicaban las Tres luces rojas en la Xbox 360? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.luzrojas44)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Un fallo general de hardware ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" La consola esta encendida ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" El funcionamiento normal ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" El anillo rojo de la muerte ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op1!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel44, MainActivity2_Nivel20::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel44, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
