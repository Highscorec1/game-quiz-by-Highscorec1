...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel37
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel38


import java.util.*
class MainActivity2_Nivel16:   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿En que país está prohibido que los menores de edad jueguen online más de 3 horas al día? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.jugar_online_sin_lag)
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel37::
            class.java)
        activityList.add(
            MainActivity2_Nivel38::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel37::class.java
                activityList.remove(MainActivity2_Nivel37::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel38::class.java
                activityList.remove(MainActivity2_Nivel38::class.java)
            }
        }
        ...
        if (op3!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel16, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
