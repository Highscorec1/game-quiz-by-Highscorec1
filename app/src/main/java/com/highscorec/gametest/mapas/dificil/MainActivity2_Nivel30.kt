...
class MainActivity2_Nivel30  :   AppCompatActivity() {
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel30, MainActivity2_Nivel13::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel30, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
