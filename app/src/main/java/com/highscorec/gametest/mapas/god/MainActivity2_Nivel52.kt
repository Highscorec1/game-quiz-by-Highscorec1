...
class MainActivity2_Nivel52  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ El juego de la imagen es __________ ?  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.plantvszombie52)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Zombies vs Plants ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Plants vs Zombies ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Conker Live and Reloaded ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" World of Padman ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel52, MainActivity2_Nivel24::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel52, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
                    mp!!.release()
