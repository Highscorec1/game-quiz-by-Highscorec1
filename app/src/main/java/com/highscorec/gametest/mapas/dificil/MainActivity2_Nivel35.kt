...
class MainActivity2_Nivel35 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿ Cuántos años estuvo en desarrollo  ARCANE  ?  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.arcane35)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op1!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel35, MainActivity2_Nivel16::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel35, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
