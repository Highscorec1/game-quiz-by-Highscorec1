...
class MainActivity2_Nivel48 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿La consola de la imagen fue desarrollada por? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.pippin48)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op1!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel48, MainActivity2_Nivel22::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel48, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
