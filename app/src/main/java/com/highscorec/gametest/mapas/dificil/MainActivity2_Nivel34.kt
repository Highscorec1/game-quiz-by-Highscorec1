...
class MainActivity2_Nivel34  :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "  ¿Quién es el actor de Far Cry 6? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.farcry34)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Antón Castillo ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Lindsay Pierre")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Giancarlo Esposito")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Sean Rey")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel34, MainActivity2_Nivel15::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel34, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
