...
class MainActivity2_Nivel31 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "  Los personajes de la imagen ¿A que juego pertenecen? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.undertale31)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" King Rooster ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Undertale ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" God of War ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Until dawn ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel31, MainActivity2_Nivel14::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel31, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
