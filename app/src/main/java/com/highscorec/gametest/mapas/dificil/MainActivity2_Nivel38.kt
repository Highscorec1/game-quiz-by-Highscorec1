...
class MainActivity2_Nivel38 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " La consola mas vendida de la historia con más de 155 millones de unidades vendidas "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.consomasvendida38)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Nintendo Switch ")
    ...
    fun Comprobar(View: View?) {
        ...
        if (op4!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel38, MainActivity2_Nivel17::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel38, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
