...
class MainActivity2_Nivel53  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageView_1!!.setImageResource(R.drawable.zeldamajo53)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" A Link to the Past")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Ocarina of Time ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Majora's Mask ")
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel53, MainActivity2_Nivel10::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel53, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
                    mp!!.release()
