...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel53
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel54


import java.util.*

class MainActivity2_Nivel24 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿ En Gran Turismo 4 cuantos coches existen ?"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable._196yr1chkl__sy445_)
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel53::
            class.java)
        activityList.add(
            MainActivity2_Nivel54::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel53::class.java
                activityList.remove(MainActivity2_Nivel53::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel54::class.java
                activityList.remove(MainActivity2_Nivel54::class.java)
            }
        }
        ...
        if (op2!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel24, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
