...
class MainActivity2_Nivel28 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " Crazy Taxi fue distribuido por _______ "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable._8crazytaxi)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op4!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel28, MainActivity2_Nivel12::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel28, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
