...
class MainActivity2_Nivel51 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ Cuántas personas conformaron el equipo de desarrollo incial del juego fall guys ?  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.fallguys51)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel51, MainActivity2_Nivel24::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel51, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
                    mp!!.release()
