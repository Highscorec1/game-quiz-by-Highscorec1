...
class MainActivity2_Nivel45 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿La imagen pertenece a un juego de pelas este es? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.soulcalibur_vi45)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Dragon Ball FighterZ ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Jump Force ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" SoulCalibur VI ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Tekken V ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel45, MainActivity2_Nivel21::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel45, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
