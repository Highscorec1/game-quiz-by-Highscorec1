...
class MainActivity2_Nivel49 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ Cómo se llama la moneda de pago del VideoJuego de la imagen ?  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.roblox49)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel49, MainActivity2_Nivel23::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel49, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
