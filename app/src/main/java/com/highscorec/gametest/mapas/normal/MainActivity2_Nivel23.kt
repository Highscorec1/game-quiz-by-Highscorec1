...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel51
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel52


import java.util.*
class MainActivity2_Nivel23 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿El primer videojuego de la historia en ser catalogado como no apto para personas menores de 18 años?"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable._8)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Grand theft auto ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Jack el Destripador")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Mortal Kombat")
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel51::
            class.java)
        activityList.add(
            MainActivity2_Nivel52::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel51::class.java
                activityList.remove(MainActivity2_Nivel51::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel51::class.java
                activityList.remove(MainActivity2_Nivel51::class.java)
        ...
        if (op2!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel23, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
