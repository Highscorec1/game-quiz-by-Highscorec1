...
class MainActivity2_Nivel33  :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "  Metal Gear Solid fue lanzado el ______"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.metalgear33)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" 20/02/2000 ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" 03/09/1998")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("11/11/1986 ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" 09/03/2010")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel33, MainActivity2_Nivel15::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel33, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
