...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel47
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel48


import java.util.*

class MainActivity2_Nivel21  :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿Reconoces a este personaje de la industria de los videojuegos? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.hideokojima_7)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Hideo Kojima")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Fumito Ueda")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Cliff Bleszinski")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("Shigeru Miyamoto")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel47::
            class.java)
        activityList.add(
            MainActivity2_Nivel48::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel47::class.java
                activityList.remove(MainActivity2_Nivel47::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel48::class.java
                activityList.remove(MainActivity2_Nivel48::class.java)
            }
        }
        ...
        if (op1!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel21, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
