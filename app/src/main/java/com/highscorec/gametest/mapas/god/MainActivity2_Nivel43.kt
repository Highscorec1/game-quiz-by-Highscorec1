...
import java.util.*
class MainActivity2_Nivel43 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " El actor que da vida a Johnny Silverhand en cyberpunk 2077  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.cyberpunk207743)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" John Wick ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Thomas A. ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Chris Nadeau ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Keanu Reeves")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op4!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel43, MainActivity2_Nivel20::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel43, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
