...
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel16
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel17
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel18
import java.util.*
import kotlin.collections.ArrayList

class MainActivity2_Nivel7 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿ Cuál es el famoso  código Konami ?"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.konami)
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(MainActivity2_Nivel16::
        class.java)
        activityList.add(MainActivity2_Nivel17::
        class.java)
        activityList.add(MainActivity2_Nivel18::
        class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel16::class.java
                // We are adding the number of the activity to the list
                activityList.remove(MainActivity2_Nivel16::class.java)
            }
            2 -> {
                activity = MainActivity2_Nivel17::class.java
                activityList.remove(MainActivity2_Nivel17::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel18::class.java
                activityList.remove(MainActivity2_Nivel18::class.java)
            }
        }
        ...
        if (op2!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel7, Bonnuslive::class.java)
