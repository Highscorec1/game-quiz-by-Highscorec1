...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel49
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel50


import java.util.*

class MainActivity2_Nivel22 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ________ Es un videojuego arcade que de existir habría sido lanzado durante 1981 en secreto por USA"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.polybius)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Pac-man")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Minecraft")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Claymore")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("Polybius")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel49::
            class.java)
        activityList.add(
            MainActivity2_Nivel50::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel49::class.java
                activityList.remove(MainActivity2_Nivel49::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel50::class.java
                activityList.remove(MainActivity2_Nivel50::class.java)
            }
        }
        ...
        if (op4!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel22, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
