...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel27
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel28
import java.util.*

class MainActivity2_Nivel11:  AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿ Crash bandicoot fue considerado la mascota de ? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.crashbandicut__1_)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Play Station")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Su dueño")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Dr Huevo")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("ActiVision")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel27::
            class.java)
        activityList.add(
            MainActivity2_Nivel28::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel27::class.java
                activityList.remove(MainActivity2_Nivel27::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel28::class.java
                activityList.remove(MainActivity2_Nivel28::class.java)
            }
        }
        ...
        if (op1!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel11, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
