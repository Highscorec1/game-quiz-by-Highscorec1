...
class MainActivity2_Nivel47 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿El juego Dead or Alive Xtreme 3 pertenece al genero de ______? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.doax3scarlet46)
        ...
        op3!!.setText(" Deportes ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("  Simulador ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel47, MainActivity2_Nivel22::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel47, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
