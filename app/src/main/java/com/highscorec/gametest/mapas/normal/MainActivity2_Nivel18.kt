...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel41
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel42


import java.util.*

class MainActivity2_Nivel18  :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ Cuál es el juego ? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.darksouls)
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel41::
            class.java)
        activityList.add(
            MainActivity2_Nivel42::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel41::class.java
                activityList.remove(MainActivity2_Nivel41::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel42::class.java
                activityList.remove(MainActivity2_Nivel42::class.java)
            }
        }
        ...
        if (op4!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel18, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
