...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel43
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel44


import java.util.*

class MainActivity2_Nivel19 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ Cuál es el juego con más tiempo en desarrollo  ? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.juegoendesarrollo)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Demon souls")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Silent hill II")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Shenmue")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("Duken Nunkem Forever")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel43::
            class.java)
        activityList.add(
            MainActivity2_Nivel44::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel43::class.java
                activityList.remove(MainActivity2_Nivel43::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel44::class.java
                activityList.remove(MainActivity2_Nivel44::class.java)
            }
        }
        ...
        if (op4!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel19, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
