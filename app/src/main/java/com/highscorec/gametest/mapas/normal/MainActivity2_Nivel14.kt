...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel33
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel34


import java.util.*

class MainActivity2_Nivel14 :   AppCompatActivity() {
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel33::
            class.java)
        activityList.add(
            MainActivity2_Nivel34::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel33::class.java
                activityList.remove(MainActivity2_Nivel33::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel34::class.java
                activityList.remove(MainActivity2_Nivel34::class.java)
            }
        }
        ...
        if (op2!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel14, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
