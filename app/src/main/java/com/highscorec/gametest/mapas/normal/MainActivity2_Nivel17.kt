...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel39
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel40


import java.util.*

class MainActivity2_Nivel17 :   AppCompatActivity() {
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel39::
            class.java)
        activityList.add(
            MainActivity2_Nivel40::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel39::class.java
                activityList.remove(MainActivity2_Nivel39::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel40::class.java
                activityList.remove(MainActivity2_Nivel40::class.java)
            }
        }
        ...
        if (op1!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel17, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
