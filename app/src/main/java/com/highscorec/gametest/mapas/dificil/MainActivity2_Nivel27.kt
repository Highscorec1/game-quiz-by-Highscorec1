...
class MainActivity2_Nivel27 :   AppCompatActivity() {
    ...
    fun Comprobar(View: View?) {
        ...
        if (op4!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel27, MainActivity2_Nivel12::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel27, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
