...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel29
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel30
import java.util.*

class MainActivity2_Nivel12 :  AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿Cuál es La franquicia de videojuegos más rentable de la historia? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.franquisia)
        ...
        op3!!.setText("Call of Duty")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("Final Fantasy")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel29::
            class.java)
        activityList.add(
            MainActivity2_Nivel30::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel29::class.java
                activityList.remove(MainActivity2_Nivel29::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel30::class.java
                activityList.remove(MainActivity2_Nivel30::class.java)
            }
        }
        ...
        if (op2!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel12, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
