...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel25
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel26

import java.util.*

class MainActivity2_Nivel10 :  AppCompatActivity() {
    ...
    private val respuesta = "27 de octubre de 2009"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿En qué fecha se estrenó League of Legends? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.leagueoflegends)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("2 de junio de 2020")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("5 de Mayo de 1999")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("20 de Diciembre de 2015")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText("27 de Octubre de 2009")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(MainActivity2_Nivel25::
        class.java)
        activityList.add(MainActivity2_Nivel26::
        class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel25::class.java
                activityList.remove(MainActivity2_Nivel25::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel26::class.java
                activityList.remove(MainActivity2_Nivel26::class.java)
            }
        }
        ...
        if (op4!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel10, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
