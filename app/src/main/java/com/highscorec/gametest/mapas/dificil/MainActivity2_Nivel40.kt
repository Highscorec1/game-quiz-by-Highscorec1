...
import java.util.*
class MainActivity2_Nivel40: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "La mayoría de cartas disponibles en Clash Royale son personajes de _______ "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.clash40)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Brawl Stars ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Clash of Clans ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Supercell ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Boom Beach ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel40, MainActivity2_Nivel18::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel40, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
