...
import java.util.*
class MainActivity2_Nivel46 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿En Guitar Hero la guitarra de la imagen se asemeja a una Real Llamada? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.gh45)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" TELECASTER Fender ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Explore Gibson ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" SG Gibson ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" FLYING Gibson ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op2!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel46, MainActivity2_Nivel21::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel46, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
