...
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel10
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel11
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel12
import java.util.*

class MainActivity2_Nivel5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "¿ Que tipo de juego es el GTA San Andreas ?"

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.gtasanandres)
        ...
        op4!!.setText("Acción-aventura de mundo abierto")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel10::
        class.java)
        activityList.add(
            MainActivity2_Nivel11::
        class.java)
        activityList.add(
            MainActivity2_Nivel12::
        class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel10::class.java
                activityList.remove(MainActivity2_Nivel10::class.java)
            }
            2 -> {
                activity = MainActivity2_Nivel11::class.java
                activityList.remove(MainActivity2_Nivel11::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel12::class.java
                activityList.remove(MainActivity2_Nivel12::class.java)
            }
        }
