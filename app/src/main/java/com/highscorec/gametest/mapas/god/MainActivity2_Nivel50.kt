...
class MainActivity2_Nivel50 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ Cuántos niveles tiene el Candy Crush Saga en 2021 ?  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.candycrush50)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op1!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel50, MainActivity2_Nivel23::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel50, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
