...
class MainActivity2_Nivel41: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = "  Friday Night Funkin' es un videojuego de ritmo creado por ______ "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.fnf41)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Alva Majo")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Hollow Knight ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" ninjamuffin99 ")
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel41, MainActivity2_Nivel19::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel41, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
