...
class MainActivity2_Nivel39: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " Bully es un videojuego no lineal desarrollado por _______  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.bully39)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Activision Blizzard ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Rockstar Games")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" CD Projekt RED ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Rockstar Vancouver  ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op4!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel39, MainActivity2_Nivel18::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel39, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
