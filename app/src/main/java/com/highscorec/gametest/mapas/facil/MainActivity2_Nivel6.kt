...
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel13
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel14
import com.highscorec.gametest.mapas.normal.MainActivity2_Nivel15
import com.highscorec.gametest.mapas.normal.*
import java.util.*

class MainActivity2_Nivel6 : AppCompatActivity() {
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(MainActivity2_Nivel13::
        class.java)
        activityList.add(MainActivity2_Nivel14::
        class.java)
        activityList.add(MainActivity2_Nivel15::
        class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel13::class.java
                // We are adding the number of the activity to the list
                activityList.remove(MainActivity2_Nivel13::class.java)
            }
            2 -> {
                activity = MainActivity2_Nivel14::class.java
                activityList.remove(MainActivity2_Nivel14::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel15::class.java
                activityList.remove(MainActivity2_Nivel15::class.java)
            }
        }
