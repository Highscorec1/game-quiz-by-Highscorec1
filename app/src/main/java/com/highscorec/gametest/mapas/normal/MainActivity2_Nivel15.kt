...
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel35
import com.highscorec.gametest.mapas.dificil.MainActivity2_Nivel36


import java.util.*

class MainActivity2_Nivel15 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿El nombre del videojuego es? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.space_invaders)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText("Space Adventure")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText("Galactic Explorer")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText("Space Invaders")
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel35::
            class.java)
        activityList.add(
            MainActivity2_Nivel36::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel35::class.java
                activityList.remove(MainActivity2_Nivel35::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel36::class.java
                activityList.remove(MainActivity2_Nivel36::class.java)
            }
        }
        ...
        if (op3!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel15, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
