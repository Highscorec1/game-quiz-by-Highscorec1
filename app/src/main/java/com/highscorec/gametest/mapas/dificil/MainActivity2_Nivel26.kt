...
class MainActivity2_Nivel26  :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " El creador del juego fue Alexei Pajitnov originario de _______ "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable._6tetris)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel26, MainActivity2_Nivel11::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel26, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
