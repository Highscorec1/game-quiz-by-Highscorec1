...
class MainActivity2_Nivel54  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿ Cuantos juegos existen de la saga angrybirds ?  "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.angrybird54)
    ...
    fun Comprobar(View: View?) {
        ...
        if (op1!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel54, MainActivity2_Nivel10::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel54, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
                    mp!!.release()
