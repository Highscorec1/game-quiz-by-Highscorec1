...
class MainActivity2_Nivel37:   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " El God of War de la imagen está basado en la mitología ________ "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.godofwar37)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" Mitología eslava ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Mitología celta ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Mitología nórdica ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Mitología egipcia ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op3!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel37, MainActivity2_Nivel17::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel37, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
