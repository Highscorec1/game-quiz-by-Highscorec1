...
class MainActivity2_Nivel36 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " The Game Award 2021 "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.gameawards36)

        op1 = findViewById(R.id.checkBox)
        op1!!.setText(" It Takes Two ")
        op2 = findViewById(R.id.checkBox2)
        op2!!.setText(" Halo infinite ")
        op3 = findViewById(R.id.checkBox3)
        op3!!.setText(" Resident evil village ")
        op4 = findViewById(R.id.checkBox4)
        op4!!.setText(" Far cry 6 ")
    }
    ...
    fun Comprobar(View: View?) {
        ...
        if (op1!!.isChecked) {
            ...
            val intent = Intent(this@MainActivity2_Nivel36, MainActivity2_Nivel16::class.java)
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel36, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
