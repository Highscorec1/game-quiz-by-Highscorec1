...
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel45
import com.highscorec.gametest.mapas.god.MainActivity2_Nivel46


import java.util.*

class MainActivity2_Nivel20 :   AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        texto1!!.text = " ¿En qué año salió el primer juego de fútbol con licencia oficial de la FIFA? "

        imageView_1 = findViewById<View>(R.id.imageView1) as ImageView
        imageView_1!!.setImageResource(R.drawable.fifa)
    ...
    fun Comprobar(View: View?) {
        ...
        activityList.add(
            MainActivity2_Nivel45::
            class.java)
        activityList.add(
            MainActivity2_Nivel46::
            class.java)
        ...
        {
            1 -> {
                activity = MainActivity2_Nivel45::class.java
                activityList.remove(MainActivity2_Nivel45::class.java)
            }
            else -> {
                activity = MainActivity2_Nivel46::class.java
                activityList.remove(MainActivity2_Nivel46::class.java)
            }
        }
        ...
        if (op2!!.isChecked) {
            ...
            when (vidas) {
                ...
                0 -> {
                    val intent = Intent(this@MainActivity2_Nivel20, Bonnuslive::class.java)
                    finish()
                    startActivity(intent)
                    mp!!.stop()
