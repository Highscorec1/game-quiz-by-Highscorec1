...
import com.highscorec.gametest.databinding.ActivitySuportheappBinding
...
class suportheapp : AppCompatActivity() {

    private var currentLevel: Int = 0
    private var interstitialAd: InterstitialAd? = null
    private lateinit var nextLevelButton: Button
    private lateinit var levelTextView: TextView
    private val TAG = "suportheapp"
    private lateinit var binding: ActivitySuportheappBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = ActivitySuportheappBinding.inflate(layoutInflater)
        ...
        InterstitialAd.load(this, getString(R.string.interstitial_ad_unit_id), adRequest,
            object : InterstitialAdLoadCallback() {
                override fun onAdLoaded(ad: InterstitialAd) {
                    ...
                    Toast.makeText(this@suportheapp, "onAdLoaded()", Toast.LENGTH_SHORT)
                        .show()
